...
<div class="mydongtaibiaoqian"><?php echo ($umsg["username"]); ?>的回答</div>
...
<input type="hidden" class="hide_upvote_status" value="<?php echo ($record_info_details["vote_value"]); ?>">
...
<?php if($$record_info_details['comment_content'] == ''): ?><a href="javascript:void(0)" class="commentbtn"><img src="/mytest/mingzhi/Public/Home/images/comment.png"/>添加评论</a>
<?php else: ?>
<a href="javascript:void(0)" class="commentbtn"><img src="/mytest/mingzhi/Public/Home/images/comment.png"/>评论</a><span class="shoucangnumber"></span><?php endif; ?>
...
<!--S 点击加载更多 -->
<div class="js-load-more js-load-more-answer"><span class="loading_span">加载更多</span><img src="/mytest/mingzhi/Public/Home/images/loading.gif" class="loading_image"/></div>
<!--E 点击加载更多-->
