...
<?php if($unanswer_qinfo['focus_id'] == ''): ?><img src="/mytest/mingzhi/Public/Home/images/add.png"/>关注问题
<?php else: ?>
<img src="/mytest/mingzhi/Public/Home/images/nofocus.png"/>取消关注<?php endif; ?>
</a>
<a href="javascript:void(0)" class="pass">不感兴趣</a>
<span class="shadow_border">
<a href="javascript:void(0);">
<?php if($unanswer_qinfo['report_id'] == ''): ?><img src="/mytest/mingzhi/Public/Home/images/report.png"/> 举报
<?php else: ?>
...
<a href="/mytest/mingzhi/Home/Topics/index" class="gototopic">话题广场</a>
</div>
...
<div class="hottopicview">
   ...
   <?php if(is_array($hot_topic)): $i = 0; $__LIST__ = $hot_topic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hot_topic): $mod = ($i % 2 );++$i;?><div class="hottopicsss">
	...
	<a href="<?php echo U('Home/Topic/index',array('tid'=>$hot_topic['id'],'sel'=>'trends'));?>" class="hottopicsss-topicname"><?php echo ($hot_topic["topic_name"]); ?></a><a href="javascript:void(0);" class="hottopicsss-tianjiafocus topic-focus-btn" data-topic-id="<?php echo ($hot_topic["id"]); ?>">
