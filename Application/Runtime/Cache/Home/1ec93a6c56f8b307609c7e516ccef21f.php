...
<div class="edit_myname_nav_info"><span><a href="/mytest/mingzhi/index.php/Home/Profile/index/u/<?php echo (session('uid')); ?>" class="username"><?php echo (session('username')); ?></a></span><img src="/mytest/mingzhi/Public/Home/images/goto.png"/> 编辑个人资料
...
<div class="myrightimage"><img src="<?php echo (session('avatar_file')); ?>"  class="mytouxiangimg">
