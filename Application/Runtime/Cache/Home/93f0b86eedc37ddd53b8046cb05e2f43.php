...
<div class="mydongtaibiaoqian"><?php echo ($umsg["username"]); ?>的问题</div>

<div class="mytrends_content">
<!--AJAX 加载个人动态  -->
 
<!--发起了问题  -->
<?php if(is_array($record_info)): $i = 0; $__LIST__ = $record_info;if( count($__LIST__)==0 ) : echo "暂无提出问题信息" ;else: foreach($__LIST__ as $key=>$record_info): $mod = ($i % 2 );++$i;?><div class="mydongtai-ua index-rightcontent">
<div class="mydongtai-ua-tag"><span class="dongtai-type-zan">发起了问题</span><span class="dongtai-time-zan"><?php echo (time2Units($record_info["create_time"])); ?></span></div>
<div class="mydongtai-ua-question"><a href="<?php echo U('Home/Question/qindex',array('qid'=>$record_info['id']));?>"><?php echo ($record_info["question_name"]); ?></a></div>
</div><?php endforeach; endif; else: echo "暂无提出问题信息" ;endif; ?> 

</div>


<!--S 点击加载更多 -->
<div class="js-load-more js-load-more-question"><span class="loading_span">加载更多</span><img src="/mytest/mingzhi/Public/Home/images/loading.gif" class="loading_image"/></div>
<!--E 点击加载更多-->
