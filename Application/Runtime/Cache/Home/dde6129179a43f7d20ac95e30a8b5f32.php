...
<?php if($hot_question['focus_id'] == ''): ?><img src="/mytest/mingzhi/Public/Home/images/add.png"/>关注问题
<?php else: ?>
...
<a href="javascript:void(0);">
<?php if($hot_question['report_id'] == ''): ?><img src="/mytest/mingzhi/Public/Home/images/report.png"/> 举报</a>
<?php else: ?>
