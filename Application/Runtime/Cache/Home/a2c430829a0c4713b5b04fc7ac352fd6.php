...
<a href="<?php echo U('Home/Topic/index',array('tid'=>$topicinfo['id'],'sel'=>'trends'));?>"  class="nav_topicname enter-topicname"><?php echo ($topicinfo["topic_name"]); ?></a> 
...
<a href="javascript:void(0);" class="topicinfoquxiao topic-focus-btn"><?php if($topicinfo['focus_id'] == ''): ?>关注话题<?php else: ?>取消关注<?php endif; ?></a>
...
<?php if($answer_info['comment_count'] == ''): ?><a href="javascript:void(0);" class="commentbtn"><img src="/mytest/mingzhi/Public/Home/images/comment.png"/>添加评论</a>
<?php else: ?>
...
<div class="replay-other-input-div">
	...
	<div >
            <div class="replay-other-btn-div">
            <input type="hidden" class="hide-replay-suid" value="<?php echo ($comment_info["suid"]); ?>"/>
		    <input type="submit" value="回复" class="replay-person-btn">
		    <input type="hidden" class="hide-answer-id" value="<?php echo ($comment_info["answer_id"]); ?>"/>
		    </div>
	</div>
</div>	
...
<input type="hidden" class="hide_question_id" value="<?php echo ($q); ?>">
<a href="javascript:void(0)" class="questionfocus focus-question-btn">
...
<div class="founderinfo">
	...
	<img src="<?php echo ($qinfo["avatar_file"]); ?>" width="40" height="40" /> <span class="founderinfo_name"><a href="/mytest/mingzhi/index.php/Home/Profile/index/u/<?php echo ($qinfo["uid"]); ?>"><?php echo ($qinfo["username"]); ?></a></span>
